...
#Plot 2
with(hhpart, plot(timestamp, Global_active_power, ylab = "Global Active Power (kilowatts)", xlab = "", type = "l"))
dev.copy(png, file="Plot2.png", width = 480, height = 480, units = "px", type = "quartz")
dev.off()
