...
legend("topright", lty = "solid", cex = 0.7, col = c("black", "red", "blue"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"))

dev.copy(png, file="Plot3.png", width = 480, height = 480, units = "px", type = "quartz")
dev.off()
